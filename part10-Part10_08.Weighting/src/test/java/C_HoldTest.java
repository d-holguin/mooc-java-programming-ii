...
public class C_HoldTest<_Item, _Suitcase, _Hold> {
    ...
    private void sanitaryCheck(String klassName, int n, String m) throws SecurityException {
        ...
        for (Field field : fields) {
            assertFalse("You do not need any \"static variables\", from class " + klassName + " remove " + field(field.toString(), klassName), field.toString().contains("static") && !field.toString().contains("final"));
